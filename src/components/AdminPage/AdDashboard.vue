            ...
            <div class="menu-button-container menu-profile d-none d-md-block">
              <button class="mdc-button mdc-menu-button">
                <span class="d-flex align-items-center">
                  <span class="figure">
                    <img src="assets/Admin/images/faces/face1.jpg" alt="user" class="user">
                  </span>
                ...
                <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="assets/Admin/images/faces/face4.jpg" alt="user">
                    </div>
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="assets/Admin/images/faces/face2.jpg" alt="user">
                    </div>
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="assets/Admin/images/faces/face3.jpg" alt="user">
                    </div>
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
