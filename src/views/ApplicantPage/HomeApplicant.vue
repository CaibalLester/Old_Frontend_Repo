<template>
  ...
  <script>
  import ApplicantPage from '@/components/ApplicantPage/HomeApplicant.vue';
  ...
  export default {
    ...
    methods: {
      loadScripts() {
        const scriptUrls = [
        '/applicantpage/vendor/bootstrap/js/bootstrap.bundle.min.js',
        '/applicantpage/vendor/aos/aos.js',
        '/applicantpage/vendor/glightbox/js/glightbox.min.js',
        '/applicantpage/vendor/swiper/swiper-bundle.min.js',
        '/applicantpage/vendor/isotope-layout/isotope.pkgd.min.js',
        '/applicantpage/vendor/php-email-form/validate.js',
        // '/applicantpage/js/main.js',
